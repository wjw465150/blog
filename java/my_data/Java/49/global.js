...
(function(){
        ...
        var load_events = [],
            ...
            return function (func) {
                ...
                if (!load_events[0]) {
                    ...
                    /*@cc_on @*/
                    /*@if (@_win32)
                        document.write("<script id=__ie_onload defer src=http://0/><\/scr"+"ipt>");
    ...
    BdAjax.request = function(url, json){
        ...
        options.onFailure = json.onFailure || function(){
			new Image().src = "/sys/statlog/1.gif?m=ajax-request&v=" + encodeURIComponent(url) + "&t=" + new Date().getTime();
...
(function(){
    var now=new Date();
    now.setTime(now.getTime()-1000*60*60*24*365); /*clear the cookie["BDTIP"] of BAIDU.COM*/
    document.cookie="BDTIP=0;expires="+now.toGMTString()+";path=/;domain=baidu.com";
})();
