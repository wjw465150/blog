...
function commentSubmit(theform,refurlk){
	...
	sDialog.init();
	if(!theform){
		sDialog.event("请您先 <a href='http://blog.51cto.com/login.php' style='color:BLUE;'>登录</a> 或 <a href='http://passport.51cto.com/reg.php?reback=" + refurlk + "' style='color:BLUE;'>注册</a> 后再进行此项操作。",'');
