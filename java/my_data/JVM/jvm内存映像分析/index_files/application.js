...
ValidationDefaultOptions.prototype = {
  onSubmit : true, //æ?¯å?¦ç??å?¬formç??submitäº?ä»¶
  stopOnFirst : false, //è¡¨å??éª?è¯?æ?¶å??ç??å?¨ç¬¬ä¸?ä¸ªéª?è¯?ç??å?°æ?¹,ä¸?ç»§ç»­éª?è¯?ä¸?å?»
  immediate : true, //æ?¯å?¦å®?æ?¶æ£?æ?¥æ?°æ?®ç??å??æ³?æ?§
  focusOnError : true, //æ?¯å?¦å?ºé??æ?¶å°?å??æ ?æ??é??ç§»å?°å?ºé??ç??è¾?å?¥æ¡?ä¸?
  useTitles : false, //æ?¯å?¦ä½¿ç?¨inputç??titleå±?æ?§ä½?ä¸ºå?ºé??æ?¶ç??æ??ç¤ºä¿¡æ?¯
  onFormValidate : function(result, form) {},//Forméª?è¯?æ?¶ç??å??è°?å?½æ?°
  onElementValidate : function(result, elm) {} //æ??ä¸ªinputéª?è¯?æ?¶ç??å??è°?å?½æ?°
};
...
ValidationUtils = {
  ...
  // é??è¿?classnameä¼ é??ç??å??æ?°å¿?é¡»é??è¿?'-'å??é??å??ä¸ªå??æ?°
  // è¿?å??å?¼å??å?«ä¸?ä¸ªå??æ?°singleArgument,ä¾?:validate-pattern-/[a-c]/gi,singleArgumentå?¼ä¸º/[a-c]/gi
...
Validator.messages = {
  ...
  'required' : 'è¯·å¡«å??å?¼.',
  'validate-number' : 'è¯·å¡«å??æ??æ??ç??æ?°å­?.',
  'validate-digits' : 'è¯·å¡«å??æ?°å­?.',
  'validate-alpha' : 'è¯·å¡«å??è?±æ??å­?æ¯?.',
  'validate-alphanum' : 'è¯·å¡«å??è?±æ??å­?æ¯?æ??æ?¯æ?°å­?,å?¶å®?å­?ç¬¦æ?¯ä¸?å??è®¸ç??.',
  'validate-email' : 'è¯·å¡«å??æ??æ??ç??é?®ä»¶å?°å??,å?ªè?½ä½¿ç?¨a-z A-Z 0-9 _ . -\',å¦? username@example.comã?? ',
  'validate-url' : 'è¯·å¡«å??æ??æ??ç??URLå?°å??.',
  'validate-currency-dollar' : 'Please enter a valid $ amount. For example $100.00 .',
  'validate-one-required' : 'å?¨ä¸?é?¢é??é¡¹è?³å°?é??æ?©ä¸?ä¸ª.',
  'validate-integer' : 'è¯·å¡«å??æ­£ç¡®ç??æ?´æ?°',
  'validate-pattern' : 'å¡«å??ç??å?¼ä¸?å?¹é??',
  'validate-ip' : 'è¯·å¡«å??æ­£ç¡®ç??IPå?°å??',
  'min-value' : 'æ??å°?å?¼ä¸º%s',
  'max-value' : 'æ??å¤§å?¼ä¸º%s',
  'min-length' : 'æ??å°?é?¿åº¦ä¸º%s,å½?å??é?¿åº¦ä¸º%s.',
  'max-length' : 'æ??å¤§é?¿åº¦ä¸º%s,å½?å??é?¿åº¦ä¸º%s.',
  'int-range' : 'å¡«å??å?¼åº?è¯¥ä¸º %s è?³ %s ç??æ?´æ?°',
  'float-range' : 'å¡«å??å?¼åº?è¯¥ä¸º %s è?³ %s ç??æ?°å­?',
  'length-range' : 'å¡«å??å?¼ç??é?¿åº¦åº?è¯¥å?¨ %s è?³ %s ä¹?é?´,å½?å??é?¿åº¦ä¸º%s',
  'equals' : 'ä¸¤æ¬¡å¡«å??ä¸?ä¸?è?´,è¯·é??æ?°å¡«å??',
  'less-than' : 'è¯·å¡«å??å°?äº?å??é?¢ç??å?¼',
  'great-than' : 'è¯·å¡«å??å¤§äº?å??é?¢ç??å?¼',
  'validate-date' : 'è¯·å¡«å??æ??æ??ç??æ?¥æ??,æ ¼å¼?ä¸º %s. ä¾?å¦?:%s.',
  'validate-file' : function(v,elm,args,metadata) {
    return ValidationUtils.format("æ??ä»¶ç±»å??åº?è¯¥ä¸º[%s]å?¶ä¸­ä¹?ä¸?",[args.join(',')]);
  },
  'validate-id-number' : 'è¯·å¡«å??å??æ³?ç??èº«ä»½è¯?å?·ç ?',
  'validate-chinese' : 'è¯·å¡«å??ä¸­æ??',
  'validate-phone' : 'è¯·å¡«å??æ­£ç¡®ç??ç?µè¯?å?·ç ?,å¦?:021-87654321,å½?å??é?¿åº¦ä¸º%s.',
  'validate-mobile-phone' : 'è¯·å¡«å??æ­£ç¡®ç??æ??æ?ºå?·ç ?,å½?å??é?¿åº¦ä¸º%s.',
  'validate-zip' : 'è¯·å¡«å??æ??æ??ç??é?®æ?¿ç¼?ç ?',
  'validate-qq' : 'è¯·å¡«å??æ??æ??ç??QQå?·ç ?.',
  'validate-richeditor' : 'è¯·å¡«å??å?¼.',
  'validate-combobox' : 'è¯·å¡«å??å?¼æ??é??å??å??é?¢ç??é??é¡¹.',
  'max-tag' : 'è¯·å¡«å??1-%sä¸ªTag.'
};

Validator.bad_words=[/fuck/i,/shit/i,/QQç¾¤/i,/MSNç¾¤/i,/æ±?(å?©|æ??)/,/(è·ª|è£¸)æ±?/,/æ?¥æ?¥|æ??å¾?æ?¥|ç´§æ?¥å¯»æ±?/,/å?¨çº¿ç­?/,/æ??(å?½|æ??|æ?¥|æ??)/,/æ?¥(!|ï¼?)/,/(é«?æ??|é«?äºº|å¤§è?¾|å¤§ä¾ |è¾¾äºº|å??è¾?|å¿«æ?¥|æ²¡æ??äºº)(æ??ç?¹|è§£ç­?|å¸®å¿?|å¸®å¸®|æ??æ??|èµ?æ??|æ??ç?¹|ä¸?å??èµ?æ??|å?°å?ª)/,/(æ??æ?¯|å¸®å¸®)(æ?°æ??|å°?å¼?|è??é¸?)/,/å¸®å¸®å¿?/, /ä¸?å??ç?«æ?¥/, /æ??é¡¶|é¡¶ä¸?å?»|å¥½è´´è¦?é¡¶|å¸®é¡¶|ç??ç??å??|é¡¶ä¸?ä¸?/,/æ??*æ²¡æ??äºº(å??ç­?|å¸®å¿?|å?³æ³¨|ç?¥é??å??|å??å¤?)/,/æ??ä¸»|è£?B|è£?13/,/å?³æ³¨(ing|ä¸­)/i,/æ?¶è??å??/,/å??æ?¶è??/,/æ?¶è??äº?/,/å?¾ä¹¦å?¼è??ä½?è??/,/è°¢è°¢æ¥¼ä¸»/,/ä¼ æ?ºæ?­å®¢/,/FineReport/i];
...
Validation.addAllThese([
  ...
  ['bad-words', function(v) {
      for (var i=0; i < Validator.bad_words.length; i++) {
        ...
        if (m) {
          alert("ITeyeå??è´´æ??ç¤º\n\nITeyeç½?ç«?ä¸?å??è®¸æ?¨ä½¿ç?¨ \"" + m[0] + "\" è¿?æ ·ç??è¯?æ±?å??è´´ï¼?\n\næ?¨å¾?å?¯è?½è¿?å??äº?ç½?ç«?è§?å??ï¼?è¯·ä»?ç»?é??è¯»å¹¶é?µå®?ç½?ç«?è§?å??ï¼?å?¦å??å°?è¢«æ?£å??å? è´´ã??\n\n");
          return false;
        }}
      return true;		
    }],
  ...
  ['max-tag', function(v, elm, args){
    return v.replace(/^\s+|\s+$/g, '').split(/,\s*|ï¼?\s*/).length <= parseInt(args[0]);
  }]
]);
...
var attachment_template = new Template('<table><tr><th>æ??ä»¶:</th><td><span>#{filename}</span><span class="more"><a href="#" class="delete">å? é?¤</a></span><div class="clear"></div></td></tr><tr><th>æ??è¿°:</th><td><textarea name="attachments[][remark]" cols="" rows=""></textarea></td></tr></table>');
...
function addAttachmentDiv(ele, max_size) {
  if (!$A(['jpg','jpeg','bmp','png','gif','rar','zip', 'tar', 'gz', 'jar', 'war', 'bz2', '7z']).any(function(extName){return new RegExp('\\.'+extName+'$','i').test(ele.value);})){
    alert("å¦?æ??æ?¨ä¸?ä¼ å?¾ç??ï¼?è¯·ä¸?ä¼ JPGã??BMPã??PNGæ??è??GIFæ ¼å¼?ç??å?¾ç??\nå¦?æ??æ?¨ä¸?ä¼ é??ä»¶ï¼?è¯·å??å??ç¼©å??ä¸?ä¼ ");
      return false;
  }
...
function addPictureDiv(ele, max_size, tags) {
  if (!$A(['jpg','jpeg','bmp','png','gif']).any(function(extName){return new RegExp('\\.'+extName+'$','i').test(ele.value);})){
    alert("æ?¨ä¸?ä¼ ç??å?¾ç??æ ¼å¼?ä¸?æ?¯æ??ï¼?è¯·æ?¨ä¸?ä¼ JPGã??BMPã??PNGæ??è??GIFæ ¼å¼?ç??å?¾ç??");
    return false;
  }
  ...
  var tag_select = "";
  if(tags.length > 0) {
    var tag_select = "<select onchange='Element.previous($(this)).value = this.value;'><option value=''>é??æ?©å·²æ??æ ?ç­¾</option>";
    for (var i = 0; i < tags.length; i++)
      tag_select += "<option value='" + tags[i] + "'>" + tags[i] + "</option>";
    tag_select += "</select>";
  }
  var div = new Element("div").update("<ul><li>æ??ä»¶: " + ele.value + " <a href='#' onclick='removePictureDiv(this, \"" + ele.id + "\");return false;'>å? é?¤</a></li><li>å??ç§°: <input type='text' name='pictures[][name]' value='" + file_name + "' size='50' class='text'/></li><li>æ??è¿°: <textarea name='pictures[][description]' style='width:400px;height:80px;'></textarea></li></ul>");
...
function extract_tag_list(value) {
    var tags = value.trim().split(/,\s*|ï¼?\s*/).without('');
    highlight_suggested_tags(tags);
    tag_list = tags.map(function(tag) { 
        return "<span>" + tag + "</span>";
    }).join('');
    if (!tag_list.empty()) {
        tag_list = 'å½?å??æ ?ç­¾ï¼?' + tag_list;
    }
...
function trigger_suggested_tag() {
  ...
  if (this.hasClassName('added')) {
    ...
    tag_list_input.value = current_value.split(/,\s*|ï¼?\s*/).findAll(function(tag){
      tag = tag.trim();
  ...
  document.observe('click', function(event){
    ...
    if(el = event.findElement('#my_resume .control .expand')){
      ...
      if($('profile_invalid_flag') && !(/myresume\/edit$/.test(el['href']))){
        alert("ä¸ªäººèµ?æ??ä¸?å®?æ?´,è¯·å??å®?å??ä¸ªäººèµ?æ??");
      }else{
      ...
      if(confirm("ç¡®å®?è¦?å? é?¤è¯¥å·¥ä½?ç»?éª?å??ï¼?")){
        if(/\#$/.test(el['href'])){
      ...
      if(confirm("ç¡®å®?è¦?å? é?¤è¯¥é¡¹ç?®ç»?éª?å??ï¼?")){
        if(/\#$/.test(el['href'])){
      ...
      if(confirm("ç¡®å®?è¦?å? é?¤è¯¥æ??è?½å??ï¼?")){
        if(/\#$/.test(el['href'])){
          el.up('li').remove();
        } else {
          var form = el.up('form');
...
function del_vote_option(vote_option){
  ...
  if(vote_option_url){
    if(confirm('æ??ç?¨,å¦?æ??ç¥¨é??é¡¹ä¸?æ??å¾?å¤?æ??ç¥¨,ä¼?å? é?¤å?¶æ??æ??æ??ç¥¨,è??å¢?å? æ??å?¡å?¨å??å??')){
  ...
  (function(){
    ...
    var Render = {
      summary_names : function(names) {
        if (names.length > 3) {
          return new Template('#{names}å??å?¦å¤?#{other}äºº').evaluate({
            'names' : names.clone().splice(0,3).join('ï¼?'), 'other' : names.length - 3
          });
        } else {
          return names.join('ï¼?');
        }
      ...
      template_blog_comment : function(notification) {
        this.render_comments_common_template(notification, 'blog', 'å??å¤?äº?æ?¨ç??å??å®¢æ??ç« ');
      },

      template_blog_comment_other : function(notification) {
        this.render_comments_common_template(notification, 'blog', 'å??å¤?äº?æ?¨å??å¤?è¿?ç??å??å®¢æ??ç« ');
      },

      template_topic_post : function(notification) {
        this.render_comments_common_template(notification, 'topic', 'å??å¤?äº?æ?¨ç??è®ºå??ä¸»é¢?', 'posts');
      },

      template_topic_post_other : function(notification) {
        this.render_comments_common_template(notification, 'topic', 'å??å¤?äº?æ?¨å??å¤?è¿?ç??è®ºå??ä¸»é¢?', 'posts');
      },

      template_group_topic_post : function(notification) {
        this.render_comments_common_template(notification, 'topic', 'å??å¤?äº?æ?¨ç??ç¾¤ç»?ä¸»é¢?', 'posts');
      },

      template_group_topic_post_other : function(notification) {
        this.render_comments_common_template(notification, 'topic', 'å??å¤?äº?æ?¨å??å¤?è¿?ç??ç¾¤ç»?ä¸»é¢?', 'posts');
      },

      template_news_comment: function(notification) {
        this.render_comments_common_template(notification, 'news', 'è¯?è®ºäº?æ?¨ç??èµ?è®¯æ??ç« ');
      },

      template_news_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'news', 'è¯?è®ºäº?æ?¨è¯?è®ºè¿?ç??èµ?è®¯æ??ç« ');
      },

      template_essence_comment: function(notification) {
        this.render_comments_common_template(notification, 'essence', 'è¯?è®ºäº?æ?¨ç??ç²¾å??æ??ç« ');
      },

      template_essence_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'essence', 'è¯?è®ºäº?æ?¨è¯?è®ºè¿?ç??ç²¾å??æ??ç« ');
      },

      template_problem_solution: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'å??ç­?äº?æ?¨ç??é?®é¢?', 'solutions');
      },

      template_problem_solution_other: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'å??ç­?äº?æ?¨å??ç­?è¿?ç??é?®é¢?', 'solutions');
      },

      template_problem_solution_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'å??ç­?äº?æ?¨å?³æ³¨ç??é?®é¢?', 'solutions');
      },

      template_problem_comment: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'è¯?è®ºäº?æ?¨ç??é?®é¢?', 'comments');
      },

      template_problem_comment_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'è¯?è®ºäº?æ?¨å?³æ³¨ç??é?®é¢?', 'comments');
      },

      template_problem_follow: function(notification) {
        this.render_comments_common_template(notification, 'problem', 'å?³æ³¨äº?æ?¨ç??é?®é¢?', 'follows');
      },

      template_solution_comment: function(notification) {
        this.render_comments_common_template(notification, 'solution', 'è¯?è®ºäº?æ?¨ç??å??ç­?', 'comments');
      },

      template_event_comment: function(notification) {
        this.render_comments_common_template(notification, 'event', 'è¯?è®ºäº?æ?¨ç??æ´»å?¨', 'comments');
      },

      template_event_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'event', 'è¯?è®ºäº?æ?¨è¯?è®ºè¿?ç??æ´»å?¨', 'comments');
      },

      template_event_comment_member: function(notification) {
        this.render_comments_common_template(notification, 'event', 'è¯?è®ºäº?æ?¨å??ä¸?ç??æ´»å?¨', 'comments');
      },

      template_page_comment: function(notification) {
        this.render_comments_common_template(notification, 'page', 'è¯?è®ºäº?æ?¨ç??ç?¥è¯?åº?', 'comments');
      },

      template_page_comment_other: function(notification) {
        this.render_comments_common_template(notification, 'page', 'è¯?è®ºäº?æ?¨è¯?è®ºè¿?ç??ç?¥è¯?åº?', 'comments');
      },
      ...
      render_comments_common_template : function(notification, subject, title, comments) {
        ...
        notification[comments].each(function(comment, index) {
          if (index > 2) {
            var template = new Template('<div class="notification_detail_item clearfix" style="display:none;"><span class="left"><a href="#{user_url}" target="_blank">#{user_name}</a>ï¼?#{body} </span><span class="time">#{time}</span></div>')
          } else {
            var template = new Template('<div class="notification_detail_item clearfix"><span class="left"><a href="#{user_url}" target="_blank">#{user_name}</a>ï¼?#{body}</span> <span class="time">#{time}</span></div>')
          }
          ...
          if (comment.url) {
            var comment_link = ' <a target="_blank" href="' + comment.url + '">æ?¥ç??</a>';
          ...
          if (index === 2 && notification[comments].length > 3) {
            ...
            var show_all = new Element('a', {'class': 'show_all'}).update('æ?¥ç??å?¦å¤?'+ (notification[comments].length - 3) + 'æ?¡' );
      ...
      template_subscription: function(notification) {
        ...
        var summary = new Template('#{names}å?³æ³¨äº?æ?¨').evaluate({
    ...
    function init_detail_paginate() {
      ...
      var prev = new Element('a', {id : 'prev_button'}).update('â?¹ ä¸?ä¸?æ?¡');
      var next = new Element('a', {id : 'next_button'}).update('ä¸?ä¸?æ?¡ â?º');
    ...
    function init_notification_menu() {
      ...
      notifications_summary.update('<div class="menu_title clearfix"><span class="title">æ??é??</span><span class="all"><a href="http://my.iteye.com/notifications">æ?¥ç??æ??æ?? Â»</a></span></div>');
      ...
      var return_button = new Element('span', {'class' : 'return left'}).update('Â« è¿?å??é??ç?¥å??è¡¨');
    ...
    function update_notifications_menu() {
      ...
      if (notifications.length > 0) {
        ...
        notifications_summary.insert('<div class="notification_summary">å½?å??æ²¡æ??æ??é??ä¿¡æ?¯</div>');
      }
    }
    ...
    function refresh_unread_count(count) {
      ...
      if (count > 0) {
        notifications_count.addClassName('new_notice').writeAttribute('title', 'æ??' + count + 'æ?¡æ?ªè¯»æ¶?æ?¯');
      } else {
        notifications_count.removeClassName('new_notice').writeAttribute('title', 'æ²¡æ??æ?ªè¯»æ¶?æ?¯');
      }
    }
    ...
    function update_notifications() {
      var loading = new Element('div', {id : 'notifications_loading'}).update('è½½å?¥ä¸­...');
...
document.observe("dom:loaded", function() {(function() {
    ...
    var AskPageAction = Class.create({
      ...
      //æ£?æµ?å½?å??æ?¯å?¦æ??å±?å?¨æ?¾ç¤ºä¸­,ä»¥ç¡®å®?æ?¯å?¦è¿?è¡?cleanå??showä»»å?¡
      //è¿?å??falseè¡¨ç¤ºæ??ä»»å?¡è¿?è¡?ä¸­,ä¸?æ¸?ç??å??æ?¾ç¤º
      //this._is_showè¡¨ç¤ºæ?¯å?¦æ?¾ç¤ºæ?°ç??å±?
      _check: function() {
        this._is_show = false;
        ...
        case 'dropdown':
          ...
          if (dropdown_status == undefined) { //å½?å??æ²¡æ??ä¸?æ??å±?
            this._is_show = true;
          } else if (dropdown_status == 'showed' && dropdown_current.event_element() != this._event_element) { //å½?å??æ??ä¸?æ??å±?,ä½?é??è¦?æ?¾ç¤ºæ?°ç??ä¸?æ??å±?
            this._is_show = true;
          } else if (dropdown_status == 'showing') { //æ??ä»»å?¡è¿?è¡?ä¸­
            return false;
          }
          break;
        case 'popup':
    ...
    var CommentAction = Class.create(PageAction, {
      ...
      show: function() {
        ...
        new Ajax.Request(url, {
          ...
          onSuccess: function(transport) {
            ...
            this._event_element.appendChild(document.createTextNode('æ?¶èµ·è¯?è®º'));
      ...
      hide: function() {
        ...
        if (comments_count > 0) comments_count_text = document.createTextNode(comments_count + 'æ?¡è¯?è®º');
        else comments_count_text = document.createTextNode('æ·»å? è¯?è®º');
