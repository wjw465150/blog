...
dp.sh.Toolbar.Create = function(highlighter)
{
    ...
    div.className = 'tools';
    div.innerHTML = highlighter.language.capitalize()+'ä»£ç ?';
    if(window.clipboardData) {
        div.innerHTML += ' <a href="#" onclick="dp.sh.Toolbar.CopyToClipboard(this);return false;" title="å¤?å?¶ä»£ç ?"><img src="/images/icon_copy.gif" alt="å¤?å?¶ä»£ç ?"/></a>';
    }else{
        var code = highlighter.originalCode.replace(/&lt;/g,'<').replace(/&gt;/g,'>').replace(/&amp;/g,'&');
