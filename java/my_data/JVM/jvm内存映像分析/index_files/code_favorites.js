...
function code_favorites_init(css_rules){
    ...
    $$(css_rules).each(function(pre){
        ...
        var favorite_link = '&nbsp;<a href="javascript:void()" title="æ?¶è??è¿?æ®µä»£ç ?" onclick="code_favorites_do_favorite(this);return false;">'
        favorite_link += '<img class="star" src="/images/icon_star.png" alt="æ?¶è??ä»£ç ?" />';
