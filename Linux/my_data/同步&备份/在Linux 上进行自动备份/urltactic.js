...
Date: May 2006
Contacts:  Sera Lewis, Diane Hoag, Tom Coppedge, Jack Pizzolato 
...
{	
	...
	var hrefString =  a.href; // get the href 
...
function setDefaultQuery(zone){
	...
	var tactics = {java : 'S_TACT=105AGX45&S_CMP=LPJAVA',
								...
								db2kit : 
'S_TACT=105AGY58& S_CMP=KITLP',
								sandbox : 'S_TACT=105AGX28&S_CMP=SANDBOX',	
								emsandbox : 'S_TACT=105AGX28&S_CMP=EMSAND',	
								alphaworks : 'S_TACT=106AH21W&S_CMP=AWLP',	
								webkit : 'S_TACT=105AGY62&S_CMP=KITLP',
								portalkit : 'S_TACT=105AGY64&S_CMP=KITLP',
								ekitlp : 'S_TACT=105AGX28&S_CMP=KITLP',
								spaces : 'S_TACT=105AGY56& S_CMP=space',
								javaspace : 'S_TACT=105AGX02&S_CMP=space',
								linuxspace : 'S_TACT=105AGX03&S_CMP=space',
								aixspace : 'S_TACT=105AGY06&S_CMP=space',
								systemsspace : 'S_TACT=105AGX12&S_CMP=space',
								db2space : 'S_TACT=105AGX11&S_CMP=space',
								lotusspace : 'S_TACT=105AGX13&S_CMP=space',
								rationalspace : 'S_TACT=105AGX15&S_CMP=space',
								tivolispace : 'S_TACT=105AGX14&S_CMP=space',
								webspherespace : 'S_TACT=105AGX10&S_CMP=space',
								workplacespace : 'S_TACT=105AGX10&S_CMP=space',
								architecturespace : 'S_TACT=105AGX78&S_CMP=space',
								autonomicspace : 'S_TACT=105AGX09&S_CMP=space',
								gridspace : 'S_TACT=105AGX07&S_CMP=space',
								ibmspace : 'S_TACT=105AGX46&S_CMP=space',
								opensourcespace : 'S_TACT=105AGX44&S_CMP=space',
								powerspace : 'S_TACT=105AGX16&S_CMP=space',
								webservicesspace : 'S_TACT=105AGX04&S_CMP=space',
								webspace : 'S_TACT=105AGX08&S_CMP=space',
								wirelessspace : 'S_TACT=105AGX05&S_CMP=space',
								xmlspace : 'S_TACT=105AGX06&S_CMP=space',
								archlp : 'S_TACT=105AGY24&S_CMP=ARCHLP'								
								}	;
