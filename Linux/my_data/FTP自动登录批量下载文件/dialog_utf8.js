 function dialog(){
	...
	var height = 180;
	var src = "";
	var path = "http://www.51cto.com/php/image/";
	...
	this.middle = function(_sId){
		...
		//var range=getRange();		
		document.getElementById(_sId)['style']['top'] = (400+ document.documentElement.scrollTop) - (document.getElementById(_sId).offsetHeight / 2);
